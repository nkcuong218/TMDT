        ...
        <AdminLayout title="Tạo Phiếu Nhập Kho">
            <div className="admin-card">
                <form onSubmit={handleSubmit} style={{ maxWidth: '1000px' }}>
                    ...
                    {loading && <p style={{ marginBottom: 12 }}>Dang tai du lieu...</p>}
                    ...
                    {formData.items.map((item, index) => (
                        <div key={item.id} style={{ display: 'grid', gridTemplateColumns: '3fr 1.5fr 1fr 1fr 1.5fr 0.5fr', gap: '15px', marginBottom: '15px', alignItems: 'end' }}>
                            <div className="form-group">
                                ...
                                >
                                    ...
                                    {variants.map(v => <option key={v.productVariantId} value={v.productVariantId}>{v.productName} ({v.sku})</option>)}
                                </select>
                            </div>
                            <div className="form-group">
                            ...
                            <div className="form-group">
                                <label style={{ fontSize: '12px', color: '#666' }}>Vị Trí</label>
                                <select
                                    className="form-input"
                                    style={{ width: '100%', padding: '8px', border: '1px solid #ddd', borderRadius: '4px' }}
